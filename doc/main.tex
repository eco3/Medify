...
The following step deals with the conceptualizing a first model of the solution, in order to map out the development. After unfolding design decisions, results are discussed. Finally the 
