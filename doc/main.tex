...
medication might lead to some health problems. To ensure the regularity of intake, reminders might assist
the consumer to keep a steady intake. A possible tool is a application for smartphones, which notifies the
...
\section{Conclusion}
\lipsum[15] %TODO
% Future revisions shall include a more attentive seeking alarm, like a ringtone which need to be canceled by the user.
